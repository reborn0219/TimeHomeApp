...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    tableViewCell.label.text = [NSString stringWithFormat:@"%@",_dataSource[indexPath.row]];
...
//    [self clickWithController:_controller];
    ...
    GasolineTypeView *view = [[GasolineTypeView alloc] initWithFrame:CGRectMake(0, 0, self.frame.size.width, self.frame.size.height) andController:nil];
...
//   [view clickWithController:_controller];
