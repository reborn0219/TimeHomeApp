...
@interface ZSY_FuelVC ()<UITableViewDelegate,UITableViewDataSource>

@property (nonatomic,strong)NSMutableArray *dataSource;

@end

@implementation ZSY_FuelVC
...
- (void)createDataSource {
    ...
    [_dataSource addObjectsFromArray:@[@"柴油",@"90#",@"92#",@"95#"]];
    //    for (int i = 0; i < 100; i++) {
    //
...
+(instancetype)sharetransmissionAlert {
    ...
    static ZSY_FuelVC * transmission = nil;
...
+(ZSY_FuelVC *)getInstance {
    ...
    ZSY_FuelVC * transmission= [[ZSY_FuelVC alloc] initWithNibName:@"ZSY_FuelVC" bundle:nil];
    return transmission;
