...
- (void)configCollectionView {
    ...
    CGFloat margin = 4;
    CGFloat itemWH = (self.view.width - 2 * margin - 4) / 3 - margin;//设置一行的个数
...
- (void)configBottomToolBar {
    ...
    [confirmButton addTarget:self action:@selector(okButtonClick) forControlEvents:UIControlEventTouchUpInside];
