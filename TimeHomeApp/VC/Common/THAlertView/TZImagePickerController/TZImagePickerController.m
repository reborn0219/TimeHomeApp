...
//    [UIApplication sharedApplication].statusBarHidden = NO;
    ...
    if (iOS7Later) {
        ...
        self.navigationBar.tintColor = TITLE_TEXT_COLOR;
    ...
    textAttrs[NSForegroundColorAttributeName] = TITLE_TEXT_COLOR;
    textAttrs[NSFontAttributeName] = DEFAULT_BOLDFONT(15);
...
- (void)pushViewController:(UIViewController *)viewController animated:(BOOL)animated {
    ...
    if (self.childViewControllers.count > 0) {
        ...
        image = [image imageWithColor:TITLE_TEXT_COLOR];
        [backButton setImage:image forState:UIControlStateNormal];
        backButton.imageEdgeInsets = UIEdgeInsetsMake(0, -5, 0, 0);
//        [backButton setTitle:@"返回" forState:UIControlStateNormal];
        backButton.titleLabel.font = [UIFont systemFontOfSize:15];
        [backButton setTitleColor:TITLE_TEXT_COLOR forState:UIControlStateNormal];
...
- (void)viewDidLoad {
    ...
    self.navigationItem.rightBarButtonItem.tintColor = TITLE_TEXT_COLOR;
