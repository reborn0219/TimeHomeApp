...
- (void)configCustomNaviBar {
    _naviBar = [[UIView alloc] initWithFrame:CGRectMake(0, 0, self.view.width, (44+statuBar_Height))];
...
//    [_selectButton setImage:[UIImage imageNamed:@"个人设置_头像_从相册选择_勾选"] forState:UIControlStateNormal];
//    [_selectButton setImage:[UIImage imageNamed:@"个人设置_头像_从相册选择_勾选"] forState:UIControlStateSelected];
