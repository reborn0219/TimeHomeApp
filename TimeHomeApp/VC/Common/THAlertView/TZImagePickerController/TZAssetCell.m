...
- (void)setModel:(TZAssetModel *)model {
    ...
    self.selectImageView.image = self.selectPhotoButton.isSelected ? [UIImage imageNamed:@"个人设置_头像_从相册选择_勾选"] : [UIImage imageNamed:@"photo_def_photoPickerVc"];
...
- (IBAction)selectPhotoButtonClick:(UIButton *)sender {
    ...
    self.selectImageView.image = sender.isSelected ? [UIImage imageNamed:@"个人设置_头像_从相册选择_勾选"] : [UIImage imageNamed:@"photo_def_photoPickerVc"];
