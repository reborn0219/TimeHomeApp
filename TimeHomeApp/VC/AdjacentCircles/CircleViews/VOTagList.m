...
- (void)commonInit{
    ...
    if (self.mutableTags == nil) {
        self.mutableTags = [self.tags mutableCopy];
    }
...
//            
//            
//            textLayer.foregroundColor = [UIColor colorWithRed:arc4random_uniform(255)/255.0 green:arc4random_uniform(255)/255.0 blue:arc4random_uniform(255)/255.0 alpha:1].CGColor;
//        }
        ...
        textLayer.foregroundColor = [UIColor colorWithRed:r/255.0 green:g/255.0 blue:b/255.0 alpha:1].CGColor;
