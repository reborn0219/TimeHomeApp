...
@interface XMLocationController ()<UITableViewDelegate,UITableViewDataSource,MKMapViewDelegate>
...
- (void)updateCenterLocation:(CLLocationCoordinate2D)centerCoordinate{
    ...
    [[XMLocationManager shareManager] reverseGeocodeWithCoordinate2D:centerCoordinate success:^(NSArray *placemarks) {
