...
//        offset.y = (contentH - _zoomingImageView.frame.size.height) * 0.5;
        ...
        if (_zoomingImageView.height_sd > _zoomingScroolView.height_sd) {
            _zoomingImageView.sd_layout.topEqualToView(_zoomingScroolView).centerYEqualToView(_zoomingScroolView);
        }else {
