...
- (void)layoutSubviews {
    ...
    self.sliderLine.borderColor=[[UIColor grayColor] CGColor];
    self.sliderLine.borderWidth=1;
...
-(void)setHandleColor:(UIColor *)handleColor{
    ...
    self.leftHandle.borderColor=[[UIColor grayColor] CGColor];
    self.rightHandle.backgroundColor = [handleColor CGColor];
    self.rightHandle.borderWidth=1;
    self.rightHandle.borderColor=[[UIColor grayColor] CGColor];
}
