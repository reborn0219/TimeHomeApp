//
//  BBSHouse0TableViewCell.m
//  TimeHomeApp
//
//  Created by UIOS on 2016/11/25.
...
@interface BBSHouse0TableViewCell ()
...
@implementation BBSHouse0TableViewCell
...
//    }
    ...
    if ([model.housetype isEqualToString:@"10"]) {//房产出售
        ...
        self.squareLal.text = [NSString stringWithFormat:@"%@㎡",model.area];
        self.roomNoLal.text = [NSString stringWithFormat:@"%@室%@厅%@卫",model.bedroom,model.livingroom,model.toilef];
        ...
        if ([[XYString IsNotNull:[NSString stringWithFormat:@"%@",model.price]] isEqualToString:@""]) {
            
            self.unitlal.text = [NSString stringWithFormat:@"0/㎡"];
        }else{
            
            self.unitlal.text = [NSString stringWithFormat:@"%@/㎡",model.price];
        }
        unitCount = 15.0;
        ...
        if ([[XYString IsNotNull:[NSString stringWithFormat:@"%@",model.price]] isEqualToString:@""]) {
            ...
            self.moneyLal.text = [NSString stringWithFormat:@"￥0/月"];
        }else{
            
            self.moneyLal.text = [NSString stringWithFormat:@"￥%@/月",model.price];
        }
        self.unitLayout.constant = 0;
        unitCount = 0;
        ...
        if ([[XYString IsNotNull:[NSString stringWithFormat:@"%@",model.price]] isEqualToString:@""]) {
            ...
            self.moneyLal.text = [NSString stringWithFormat:@"￥%@",model.price];
        }
        self.unitLayout.constant = 0;
        unitCount = 0;
        ...
        self.tag2Lal.text = @"  出租  ";
        self.pointHide.hidden = NO;
        self.roomNoLal.hidden = NO;
        
        self.squareLal.text = [XYString IsNotNull:[NSString stringWithFormat:@"%@㎡",model.area]];
        ...
        if ([[XYString IsNotNull:[NSString stringWithFormat:@"%@",model.price]] isEqualToString:@""]) {
            ...
            self.unitlal.text = [NSString stringWithFormat:@"%@/平米",model.price];
        }
        unitCount = 0;
    }
    ...
    float height = 13 + 47 + 5 + size.height + 10 + 18 + 8 + 1 + 15 + 20 + 15 + 10 + unitCount;
    
    model.height = height + 11;
}
