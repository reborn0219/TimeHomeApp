...
@interface BBSHouse1TableViewCell ()
...
@implementation BBSHouse1TableViewCell
...
//    }
    ...
    if (imgArr.count > 0) {
        ...
        UIImage *img = [UIImage imageNamed:@"车位默认图片"];
        [self.image1 performSelectorOnMainThread:@selector(setImage:) withObject:img waitUntilDone:NO];
    }
    ...
    float height = 13 + 47 + 5 + size.height + 5 + 10 + 18 + 8 + 1 + 10 + 20 + 10 + 10 + 20 + 5 + unitCount + (SCREEN_WIDTH - 20 - 2 * 8) / 648 * 432;
