...
@interface BBSHouse2TableViewCell ()
...
@implementation BBSHouse2TableViewCell
...
//    }
    ...
    float height = 13 + 47 + 5 + size.height + 5 + 10 + 18 + 8 + 1 + 10 + 20 + 10 + 10 + 20 + 5 + unitCount + (SCREEN_WIDTH - 20 - 10 - 2 * 8) / 2;
