...
@implementation BBSVoteTextTableViewCell
...
- (void)setModel:(BBSModel *)model {
    ...
    int red3 = [arr[2][@"votocount"] intValue];
    ...
    self.voteInfo3Lal.text = [XYString IsNotNull:[NSString stringWithFormat:@"%@",arr[2][@"content"]]];
    self.voteNumber3Lal.text = [XYString IsNotNull:[NSString stringWithFormat:@"%d",red3]];
    self.back3View.layer.cornerRadius = 8;
    self.back3View.layer.masksToBounds = YES;
    self.red3View.layer.cornerRadius = 8;
    self.red3View.layer.masksToBounds = YES;
    self.whitePoint3.layer.cornerRadius = 2;
    self.whitePoint3.layer.masksToBounds = YES;
    ...
    if (red1 == 0) {
        ...
        self.red3ViewLayout.constant = 0;
        ...
        self.red1ViewLayout.constant = width;
        self.red2ViewLayout.constant = width / red1 * red2;
        self.red3ViewLayout.constant = width / red1 * red3;
    }
