...
@interface BBSVoteTextTableViewCell : UITableViewCell
...
@property (weak, nonatomic) IBOutlet UILabel *voteNumber3Lal;

@property (weak, nonatomic) IBOutlet UILabel *voteInfo3Lal;

@property (weak, nonatomic) IBOutlet UIView *back3View;

@property (weak, nonatomic) IBOutlet UIView *red3View;

@property (weak, nonatomic) IBOutlet UIImageView *whitePoint3;

@property (weak, nonatomic) IBOutlet NSLayoutConstraint *red3ViewLayout;
