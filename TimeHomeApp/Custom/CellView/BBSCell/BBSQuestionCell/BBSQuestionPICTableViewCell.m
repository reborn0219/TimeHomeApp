...
@implementation BBSQuestionPICTableViewCell
...
//    self.infoLal.text = [XYString IsNotNull:[NSString stringWithFormat:@"%@",model.title]];
    ...
    float height = 18 + 13 + 12 + size.height + 10 + 7 + hideShow + 6 + 1 + 10 + 20 + 10 + 10 + 20 + 5 +(SCREEN_WIDTH - 20 - 2 * 10 - 2 * 8) / 3;
