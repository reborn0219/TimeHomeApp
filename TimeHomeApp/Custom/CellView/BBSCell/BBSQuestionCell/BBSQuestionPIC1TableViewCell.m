//
//  BBSQuestionPIC1TableViewCell.m
//  TimeHomeApp
//
...
@implementation BBSQuestionPIC1TableViewCell
...
//    }
    ...
    if(size.height > 36.0){
        ...
        self.allTextLal.hidden = NO;
    }else{
        
        self.allTextLayout.constant = 0;
        
        self.allTextLal.hidden = YES;
    }
    ...
    float height = 18 + 13 + 12 + size.height + 10 + 7 + hideShow + 6 + 1 + 10 + 20 + 10 + 10 + 20 + 5 + (SCREEN_WIDTH - 20 - 2 * 8) / 648 * 432;
