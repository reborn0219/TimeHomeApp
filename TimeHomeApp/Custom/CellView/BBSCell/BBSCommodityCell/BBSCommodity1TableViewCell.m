...
@interface BBSCommodity1TableViewCell ()
...
@implementation BBSCommodity1TableViewCell
...
- (void)setModel:(BBSModel *)model {
    ...
    float height = 13 + 47 + 5 + size.height + 5 + 10 + 18 + 8 + 1 + 15 + 20 + 15 + 10 + (SCREEN_WIDTH - 20 - 2 * 8) / 648 * 432;
