...
#import "PANetAesJsonDataCommond.h"
#import "NetWorks.h"

@implementation PANetAesJsonDataCommond

-(void)execute:(CommandModel *)param CompleteBlock:(CommandCompleteBlock)completeBlock
{
    NSString * paramstr = param.jsonStr;
    NSMutableURLRequest * request=[self creadRequestForParam:paramstr url:param.commandUrl];
    [NetWorks NSURLSessionForRedBagRequst:request CompleteBlock:completeBlock];
}
///生成post参数
